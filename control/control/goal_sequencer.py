#!/usr/bin/env python3
"""
Publish a sequence of goals to /planning/goal, driven by local pose feedback.
Intended to run on a separate "shore" machine while the boat runs all_in_one_stack
with auto_goal_enable disabled.
"""
